 ...
 * Version: 2.5.1 - 2019-01-02
 * License: MIT
 * Fix: problem build uglify and ngAnnotate 
 */
...
angular.module('ui.bootstrap.accordion', ['ui.bootstrap.collapse', 'ui.bootstrap.tabindex'])
    ...
    .controller('UibAccordionController', ['$scope', '$attrs', 'uibAccordionConfig',
        function ($scope, $attrs, uibAccordionConfig) {
...
angular.module('ui.bootstrap.datepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.isClass'])
    ...
    .controller('UibDatepickerController', ['$scope', '$element', '$attrs', '$parse', '$interpolate', '$locale', '$log', 'dateFilter', 'uibDatepickerConfig', '$datepickerLiteralWarning', '$datepickerSuppressError', 'uibDateParser',
        function ($scope, $element, $attrs, $parse, $interpolate, $locale, $log, dateFilter, uibDatepickerConfig, $datepickerLiteralWarning, $datepickerSuppressError, uibDateParser) {
            var self = this,
                ngModelCtrl = {
                ...
                switch (key) {
                    ...
                    case 'datepickerMode':
                        $scope.datepickerMode = angular.isDefined($scope.datepickerOptions.datepickerMode) ?
                            $scope.datepickerOptions.datepickerMode : uibDatepickerConfig.datepickerMode;
                        break;
                    case 'formatDay':
                    ...
                    case 'yearRows':
                        self[key] = angular.isDefined($scope.datepickerOptions[key]) ?
                            $scope.datepickerOptions[key] : uibDatepickerConfig[key];
                        break;
                    case 'startingDay':
            ...
            this.init = function (ngModelCtrl_) {
                ...
                if ($scope.datepickerOptions.initDate) {
                    self.activeDate = uibDateParser.fromTimezone($scope.datepickerOptions.initDate, ngModelOptions.getOption('timezone')) || new Date();
            ...
            $scope.select = function (date) {
                if ($scope.datepickerMode === self.minMode) {
                    var dt = ngModelCtrl.$viewValue ? uibDateParser.fromTimezone(new Date(ngModelCtrl.$viewValue), ngModelOptions.getOption('timezone')) : new Date(0, 0, 0, 0, 0, 0, 0);
...
angular.module('ui.bootstrap.datepickerPopup', ['ui.bootstrap.datepicker', 'ui.bootstrap.position'])
    ...
    .controller('UibDatepickerPopupController', ['$scope', '$element', '$attrs', '$compile', '$log', '$parse', '$window', '$document', '$rootScope', '$uibPosition', 'dateFilter', 'uibDateParser', 'uibDatepickerPopupConfig', '$timeout', 'uibDatepickerConfig', '$datepickerPopupLiteralWarning',
        function ($scope, $element, $attrs, $compile, $log, $parse, $window, $document, $rootScope, $uibPosition, dateFilter, uibDateParser, uibDatepickerPopupConfig, $timeout, uibDatepickerConfig, $datepickerPopupLiteralWarning) {
            var cache = {},
            ...
            this.init = function (_ngModel_) {
                ...
                onOpenFocus = angular.isDefined($attrs.onOpenFocus) ?
                    $scope.$parent.$eval($attrs.onOpenFocus) : uibDatepickerPopupConfig.onOpenFocus;
                datepickerPopupTemplateUrl = angular.isDefined($attrs.datepickerPopupTemplateUrl) ?
                    $attrs.datepickerPopupTemplateUrl :
                    uibDatepickerPopupConfig.datepickerPopupTemplateUrl;
                datepickerTemplateUrl = angular.isDefined($attrs.datepickerTemplateUrl) ?
                    $attrs.datepickerTemplateUrl : uibDatepickerPopupConfig.datepickerTemplateUrl;
...
angular.module('ui.bootstrap.dropdown', ['ui.bootstrap.multiMap', 'ui.bootstrap.position'])
    ...
    .controller('UibDropdownController', ['$scope', '$element', '$attrs', '$parse', 'uibDropdownConfig', 'uibDropdownService', '$animate', '$uibPosition', '$document', '$compile', '$templateRequest',
        function ($scope, $element, $attrs, $parse, uibDropdownConfig, uibDropdownService, $animate, $uibPosition, $document, $compile, $templateRequest) {
            var self = this,
                scope = $scope.$new(), // create a child scope so we are not polluting original one
                templateScope,
                appendToOpenClass = uibDropdownConfig.appendToOpenClass,
            ...
            scope.$watch('isOpen', function (isOpen, wasOpen) {
                ...
                if (appendTo && self.dropdownMenu) {
                    var pos = $uibPosition.positionElements($element, self.dropdownMenu, 'bottom-left', true),
                        css,
                        rightalign,
                        scrollbarPadding,
                        scrollbarWidth = 0;
                    ...
                    if (!rightalign) {
                        ...
                        css.left = 'auto';
                        scrollbarPadding = $uibPosition.scrollbarPadding(appendTo);
                    ...
                    if (!appendToBody) {
                        var appendOffset = $uibPosition.offset(appendTo);
...
angular.module('ui.bootstrap.pager', ['ui.bootstrap.paging', 'ui.bootstrap.tabindex'])
    ...
    .controller('UibPagerController', ['$scope', '$attrs', 'uibPaging', 'uibPagerConfig',
...
angular.module('ui.bootstrap.pagination', ['ui.bootstrap.paging', 'ui.bootstrap.tabindex'])
    .controller('UibPaginationController', ['$scope', '$attrs', '$parse', 'uibPaging', 'uibPaginationConfig',
...
angular.module('ui.bootstrap.tooltip', ['ui.bootstrap.position', 'ui.bootstrap.stackedMap'])
    ...
    .provider('$uibTooltip', function () {
         ...
         */
        this.$get = ['$window', '$compile', '$timeout', '$document', '$uibPosition', '$interpolate', '$rootScope', '$parse', '$$stackedMap', function ($window, $compile, $timeout, $document, $uibPosition, $interpolate, $rootScope, $parse, $$stackedMap) {
                    ...
                    compile: function (tElem, tAttrs) {
                        ...
                        return function link(scope, element, attrs, tooltipCtrl) {
                            ...
                            var positionTooltip = function () {
                                ...
                                if (!positionTimeout) {
                                    positionTimeout = $timeout(function () {
                                        var ttPosition = $uibPosition.positionElements(element, tooltip, ttScope.placement, appendToBody);
                                        var initialHeight = angular.isDefined(tooltip.offsetHeight) ? tooltip.offsetHeight : tooltip.prop('offsetHeight');
                                        var elementPos = appendToBody ? $uibPosition.offset(element) : $uibPosition.position(element);
                                        tooltip.css({
                                        ...
                                        adjustmentTimeout = $timeout(function () {
                                            ...
                                            var adjustment = $uibPosition.adjustTop(placementClasses, elementPos, initialHeight, currentHeight);
                                            if (adjustment) {
                                        ...
                                        if (tooltip.hasClass('uib-position-measure')) {
                                            $uibPosition.positionArrow(tooltip, ttPosition.placement);
                            ...
                            function prepareTooltip() {
                                ...
                                var placement = $uibPosition.parsePlacement(ttScope.placement);
...
angular.module('ui.bootstrap.progressbar', [])
    ...
    .controller('UibProgressController', ['$scope', '$attrs', 'uibProgressConfig', function ($scope, $attrs, uibProgressConfig) {
        var self = this,
            animate = angular.isDefined($attrs.animate) ? $scope.$parent.$eval($attrs.animate) : uibProgressConfig.animate;
        ...
        function getMaxOrDefault() {
            return angular.isDefined($scope.maxParam) ? $scope.maxParam : uibProgressConfig.max;
        }
    }])
...
angular.module('ui.bootstrap.rating', [])
    ...
    .controller('UibRatingController', ['$scope', '$attrs', 'uibRatingConfig', function ($scope, $attrs, uibRatingConfig) {
        var ngModelCtrl = {
                $setViewValue: angular.noop
            },
            self = this;
        ...
        this.init = function (ngModelCtrl_) {
            ...
            this.stateOn = angular.isDefined($attrs.stateOn) ? $scope.$parent.$eval($attrs.stateOn) : uibRatingConfig.stateOn;
            this.stateOff = angular.isDefined($attrs.stateOff) ? $scope.$parent.$eval($attrs.stateOff) : uibRatingConfig.stateOff;
            this.enableReset = angular.isDefined($attrs.enableReset) ?
                $scope.$parent.$eval($attrs.enableReset) : uibRatingConfig.enableReset;
            var tmpTitles = angular.isDefined($attrs.titles) ? $scope.$parent.$eval($attrs.titles) : uibRatingConfig.titles;
            this.titles = angular.isArray(tmpTitles) && tmpTitles.length > 0 ?
                tmpTitles : uibRatingConfig.titles;

            var ratingStates = angular.isDefined($attrs.ratingStates) ?
                $scope.$parent.$eval($attrs.ratingStates) :
                new Array(angular.isDefined($attrs.max) ? $scope.$parent.$eval($attrs.max) : uibRatingConfig.max);
...
angular.module('ui.bootstrap.timepicker', [])
    ...
    .controller('UibTimepickerController', ['$scope', '$element', '$attrs', '$parse', '$log', '$locale', 'uibTimepickerConfig',
        function ($scope, $element, $attrs, $parse, $log, $locale, uibTimepickerConfig) {
            ...
            var selected = new Date(),
                ...
                meridians = angular.isDefined($attrs.meridians) ? $scope.$parent.$eval($attrs.meridians) : uibTimepickerConfig.meridians || $locale.DATETIME_FORMATS.AMPMS,
            ...
            this.init = function (ngModelCtrl_, inputs) {
                ...
                var mousewheel = angular.isDefined($attrs.mousewheel) ? $scope.$parent.$eval($attrs.mousewheel) : uibTimepickerConfig.mousewheel;

                if (mousewheel) {
                    this.setupMousewheelEvents(hoursInputEl, minutesInputEl, secondsInputEl);
                }

                var arrowkeys = angular.isDefined($attrs.arrowkeys) ? $scope.$parent.$eval($attrs.arrowkeys) : uibTimepickerConfig.arrowkeys;
                if (arrowkeys) {
                    this.setupArrowkeyEvents(hoursInputEl, minutesInputEl, secondsInputEl);
                }

                $scope.readonlyInput = angular.isDefined($attrs.readonlyInput) ? $scope.$parent.$eval($attrs.readonlyInput) : uibTimepickerConfig.readonlyInput;
                this.setupInputEvents(hoursInputEl, minutesInputEl, secondsInputEl);
            };

            var hourStep = uibTimepickerConfig.hourStep;
            if ($attrs.hourStep) {
            ...
            var minuteStep = uibTimepickerConfig.minuteStep;
            if ($attrs.minuteStep) {
            ...
            var secondStep = uibTimepickerConfig.secondStep;
            if ($attrs.secondStep) {
            ...
            $scope.showSeconds = uibTimepickerConfig.showSeconds;
            ...
            // 12H / 24H mode
            $scope.showMeridian = uibTimepickerConfig.showMeridian;
            ...
            $scope.showSpinners = angular.isDefined($attrs.showSpinners) ?
                $scope.$parent.$eval($attrs.showSpinners) : uibTimepickerConfig.showSpinners;
...
angular.module('ui.bootstrap.typeahead', ['ui.bootstrap.debounce', 'ui.bootstrap.position'])
    ...
    .controller('UibTypeaheadController', ['$scope', '$element', '$$attrs', '$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$$debounce', '$uibPosition', 'uibTypeaheadParser',
        function ($scope, element, $attrs, $compile, $parse, $q, $timeout, $document, $window, $rootScope, $$debounce, $uibPosition, uibTypeaheadParser) {
...
angular.module("uib/template/tabs/tab.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("uib/template/tabs/tab.html",
        ...
        "  <a ng-class=\"[{active: active, disabled: disabled}, classes]\" href ng-click=\"select($event)\" class=\"nav-link\" uib-tab-heading-transclude>{{heading}}</a>\n" +
        "</li>\n" +
        "");
}]);
